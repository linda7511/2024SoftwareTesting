...
export default {
    data() {
        return {
            ...
            items: [
                {
                    index:'/e_materialOnly/purchasing_materials',
                    key:'3.1',
                    title:'采购物资',
                },
                {
                    index:'/e_materialOnly/view_inventory',
                    key:'3.2',
                    title:'查看库存',
                },
                {
                    index:'/e_materialOnly/maintain_records',
                    key:'3.3',
                    title:'维护记录',
                },
                {
                    index:'/e_materialOnly/consumption_records',
                    key:'3.5',
                    title:'消耗记录',
                },
            ],
