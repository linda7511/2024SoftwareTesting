                            ...
                            <template v-for="item in items" :key="item.key">
                                ...
                                <template v-else>
                                    <el-menu-item :index="item.index">
                                        <template #title>
                                            <label class="sidebar-subs"> {{ item.title }} </label>
                                        </template>
                                    </el-menu-item>
                                </template>
                            </template>
...
export default {
    data() {
        return {
            ...
            items: [
                {
                    index: '/e_frontReceptionOnly/room_clean',
                    key: '2.1',
                    title: '客房清洁',
                },
                {
                    index: '/e_frontReceptionOnly/repair_tasks',
                    key: '2.2',
                    title: '维修任务',
                },
                {
                    index: '/e_frontReceptionOnly/settlement_bill',
                    key: '2.3',
                    title: '结算帐单',
                },
                {
                    index: '/e_frontReceptionOnly/resident_checkin',
                    key: '2.4',
                    title: '宾客入住',
                },
                {
                    index: '/e_frontReceptionOnly/idle_query',
                    key: '2.5',
                    title: '空闲查询',
                },
                {
                    index: '/e_frontReceptionOnly/guest_info',
                    key: '2.6',
                    title: '宾客信息',
                },
                {
                    index: '/e_frontReceptionOnly/process_order',
                    key: '2.7',
                    title: '处理订单',
                },
                {
                    index: '/e_frontReceptionOnly/online_orders',
                    key: '2.8',
                    title: '网络订单',
                },
            ],
