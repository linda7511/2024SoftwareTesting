        ...
        <el-container>
            <el-header>
                <div class="header">
                    ...
                    <el-button class="change-pwd" @click="changePwdVisible = true"><span
                            class="btn-text">修改密码</span></el-button>
                </div>
            </el-header>
            <el-container class="content-wrapper">
                <el-aside width="250px" style="background-color: #324157;">
                    <div class="sidebar">
                        <div class="avatar">
                            <el-avatar @click="userInfoVisiblie = true" :size="128" shape="circle"
                                src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png"
                                class="avatar-img"></el-avatar>
                        </div>
                            ...
                            <template v-for="item in items" :key="item.key">
                                <template v-if="item.subs">
                                    <el-sub-menu :index="item.index">
                                        ...
                                        <el-menu-item v-for="subItem in item.subs" :key="subItem.key"
                                            :index="subItem.index">
        ...
        <div class="home-dialogs">
            ...
            <el-dialog title="修改密码" v-model="changePwdVisible" width="25%">
                ...
                <div class="dialog-buttons">
                    ...
                    <button class="dialog-cancel-button" @click="pwdOrigin = ''; pwdNew = ''; changePwdVisible = false">
                        取消
                    </button>
                </div>
            </el-dialog>
